...
[![Integration level](https://apps.yunohost.org/badge/integration/zola)](https://ci-apps.yunohost.org/ci/apps/zola/)
![Working status](https://apps.yunohost.org/badge/state/zola)
![Maintenance status](https://apps.yunohost.org/badge/maintained/zola)
